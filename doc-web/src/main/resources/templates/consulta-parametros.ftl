...
<!-- 	2017-02-13 jgarcia@controltechcg.com #142: Reordenamiento de los campos del formulario para que no se crucen entre ellos. -->
	...
	<div class="form-group row">
	    <label for="fechaInicio" class="col-sm-2 col-form-label text-xs-right">Fecha Inicial</label>
	    <div class="col-sm-10">
	    	<input type="text" name="fechaInicio" class="form-control datepicker" />
	    </div>
	</div>
	
	<div class="form-group row">
	    <label for="fechaFin" class="col-sm-2 col-form-label text-xs-right">Fecha Final</label>
	    <div class="col-sm-10">
		    <input type="text" name="fechaFin" class="form-control datepicker" />
	    </div>
	</div>

	<div class="form-group row">
	    <label for="asignado" class="col-sm-2 col-form-label text-xs-right">Asignado a</label>
	    <div class="col-sm-10">
	...
	<div class="form-group row">
	    <label for="asunto" class="col-sm-2 col-form-label text-xs-right">Asunto</label>
	    <div class="col-sm-10">
	...
	<div class="form-group row">
	    <label for="radicado" class="col-sm-2 col-form-label text-xs-right">Radicado</label>
	    <div class="col-sm-10">
	...
	<div class="form-group row">
	    <label for="destinatario" class="col-sm-2 col-form-label text-xs-right">Destinatario</label>
	    <div class="col-sm-10">
	...
	<div class="form-group row">
	    <label for="clasificacion" class="col-sm-2 col-form-label text-xs-right">Clasificación</label>
	    <div class="col-sm-10">
	...
	<div class="form-group row">
	    <label for="destinatario" class="col-sm-2 col-form-label text-xs-right">Dependencia destino</label>
