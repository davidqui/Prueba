	...
	<@flash/>
        <form action="/admin/dominio/crear" method="POST" enctype="multipart/form-data" >
            ...
            <fieldset class="form-group">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" value="${(dominio.nombre)!""}"/>
                </fieldset>
            ...
            <fieldset class="form-group">
                ...
                <#if dominio.visualizaLinkOWA?? && dominio.visualizaLinkOWA==true>
                    <input class="form-control" type="checkbox" name="visualizaLinkOWA" id="visualizaLinkOWA" checked="checked" />
                <#else>
                    <input class="form-control" type="checkbox" name="visualizaLinkOWA" id="visualizaLinkOWA"/>
                </#if>
