...
<div class="container-fluid">
    ...
    <p>
        ...
        <a href="/admin/transjustificaciondefecto/create" class="btn btn-success btn-sm">Crear nuevo</a>
    </p>
    ...
    <#else>
                ...
                <#list descriptor.listProperties() as p>
                	...
                	<td nowrap="nowrap">
                            <#if x.activo?? && x.activo == true >
                                <a href=${"/admin/transjustificaciondefecto/edit?id="+x.tjdId} class="btn btn-sm btn-warning" title="Modificar">M</a>
                                <a href=${"/admin/transjustificaciondefecto/delete?id="+x.tjdId} class="btn btn-sm btn-danger" title="Eliminar" onclick="return confirm('¿Está seguro que desea eliminar el registro?');">E</a>
                            </#if>
                        <#if x.cuando?? >
                            <#if x.cuandoMod?? >
        ...
        <#if totalPages gt 0>
            <@printBar url="/admin/transjustificaciondefecto" params={"filtro": filtro!"", "all": all?string("true", "false") } metodo="get"/>
        </#if>
    </#if>
