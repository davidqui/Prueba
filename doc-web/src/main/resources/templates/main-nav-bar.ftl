<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
      ...
      <#if username?? >
        <ul class="nav navbar-nav">
          <li class="nav-item">
            <a href="/bandeja" class="btn btn-primary">Bandejas</a>
          </li>
          <li class="nav-item">
            <a href="/proceso/list" class="btn btn-success">Registro</a>
          </li>
          <li class="nav-item">
            <a href="/expediente/list?arch=1" class="btn btn-secondary">Expedientes</a>
          </li>
          <li class="nav-item">
            <a href="/expediente/carpeta" class="btn btn-secondary">Carpetas</a>
          </li>
          <li class="nav-item">
