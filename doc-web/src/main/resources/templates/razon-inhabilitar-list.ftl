...
<div class="container-fluid">
    ...
    <p>
        ...
        <a href="/admin/razon-inhabilitar/create" class="btn btn-success btn-sm">Crear nuevo</a>
    </p>
                ...
                <#list descriptor.listProperties() as p>
                	...
                	<td nowrap="nowrap">
                            <#if x.activo?? && x.activo == true >
                                <a href=${"/admin/razon-inhabilitar/edit?id=" + x.id} class="btn btn-sm btn-warning" title="Modificar">M</a>
                                <a href=${"/admin/razon-inhabilitar/delete?id=" + x.id} class="btn btn-sm btn-danger" title="Eliminar" onclick="return confirm('¿Está seguro que desea eliminar el registro?');">E</a>
                            </#if>
                        <#if x.cuando?? >
                            <#if x.cuandoMod?? >
