...
public class ProcesoUtils {
    ...
    /**
     * Mapa de identificadores de procesos con sus correspondientes roles de
     * autorización.
     */
    /*
     ...
     * feature-162.
     */
    public static final Map<Integer, RolConstants> PROCESOS_ROLES_MAP;

    static {
        final Map<Integer, RolConstants> map = new LinkedHashMap<>();
        map.put(Proceso.ID_TIPO_PROCESO_REGISTRAR_Y_CONSULTAR_DOCUMENTOS, RolConstants.REGISTRO);
        map.put(Proceso.ID_TIPO_PROCESO_GENERAR_Y_ENVIAR_DOCUMENTO_PARA_UNIDADES_DE_INTELIGENCIA_Y_CONTRAINTELIGENCIA, null);
        map.put(Proceso.ID_TIPO_PROCESO_GENERAR_DOCUMENTOS_PARA_ENTES_EXTERNOS_O_PERSONAS, null);
        map.put(Proceso.ID_TIPO_PROCESO_REGISTRO_ACTAS, RolConstants.PROCESAR_REGISTRO_ACTAS);

        PROCESOS_ROLES_MAP = Collections.unmodifiableMap(map);
    }
