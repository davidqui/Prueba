...
public class GeneralUtils {
	 ...
	 * 
	 * @param obj
	 *            El objeto raiz sobre el que se inicia la evaluación del camino
	 * @param path
	 *            El camino representado en un arreglo de cadenas,cada una
	 *            representando una propiedad
	 * @param index
	 *            Índice del camino desde el que se inicia la evaluación
	 * @return
	 * @throws SintaxisException
	 * @throws InvocacionException
	 */
