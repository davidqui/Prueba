...
public class DocumentoController extends UtilController {
	...
	public @ResponseBody String documentoHtmlSeleccionado(@RequestParam("id") String id) {
	 ...
	 * @param doc
	 *            La información del documento que proviene del formulario
	 * @param docBind
	 *            Enlace del framework con la entidad
	 * @param model
	 *            Modelo para la vista
	 * @param principal
	 *            Usuario
	 * @param redirect
	 *            Información para la redirección
	 * @return
	 */
	 ...
	 * 
	 * @param pin
	 *            Indentificador de la instancia de proceso
	 * @param model
	 * @param req
	 * @param principal
	 * @return
	 ...
	 *         sistema se encuentre dentro del rango de asignación del jefe
	 *         encargado y este se encuentre activo en el sistema, se retorna el
	 *         jefe encargado; de lo contrario, se retorna el jefe principal de
	 *         la dependencia.
	 */
	// 2017-02-09 jgarcia@controltechcg.com Issue #11 (SIGDI-Incidencias01)
	// 2017-02-09 jgarcia@controltechcg.com Issue #11 (SIGDI-Incidencias01):
	...
	public @ResponseBody Map<String, String> getInfoDoc(@RequestParam("docId") String docId) {
	 ...
	 *            Es el identificador del documento
	 * @param expid
	 *            El id del expediente al que se va a mover el documento
	 * 
	 * 
	 * @return
	 */
