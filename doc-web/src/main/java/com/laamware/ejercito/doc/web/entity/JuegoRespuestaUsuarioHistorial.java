...
@Entity
@Table(name = "H_JUEGO_RESPUESTA_USUARIO")
public class JuegoRespuestaUsuarioHistorial extends AuditActivoCreateSupport {

	@Id
	@GenericGenerator(name = "H_JUEGO_RESPUESTA_USUARIO_SEQ", strategy = "sequence", parameters = {
			@Parameter(name = "sequence", value = "H_JUEGO_RESPUESTA_USUARIO_SEQ"),
			@Parameter(name = "allocationSize", value = "1") })
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "H_JUEGO_RESPUESTA_USUARIO_SEQ")
	@Column(name = "HJRU_ID")
	private Integer id;
