...
@Component
public class PrestamoSolicitudDocValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (prestamoSolicitud.getDocumento() == null
				|| prestamoSolicitud.getDocumento().getId() == null) {
			errors.rejectValue("documento", "prestamoSolicitud.documento.empty");
