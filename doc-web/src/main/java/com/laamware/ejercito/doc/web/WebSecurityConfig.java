...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        if (authMode.equals("ad")) {
             ...
             * sistema.
             * 
             * 2017-07-12 jgarcia@controltechcg.com Issue #123
             * (SICDI-Controltech) hotfix-123: Corrección para que únicamente
             * realice validación de login con usuarios activos en la plataforma.
             */
