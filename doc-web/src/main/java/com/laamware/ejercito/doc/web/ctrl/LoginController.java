...
public class LoginController {
	...
	String login(@RequestParam(value = "error", required = false) String error, @RequestParam(value = "logout", required = false) String logout, HttpServletRequest req, Model model) {
	...
	String invitacion() {	
		...
		if( aut != null && aut.isAuthenticated() && aut.getPrincipal() != null && !aut.getPrincipal().toString().equals("anonymousUser") ){
