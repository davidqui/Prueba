...
public class PreguntaController extends UtilController {
    ...
    public String create(@PathVariable(value = "key") Integer key, Model model) {
        ...
        TemaCapacitacion dataTemaCapacitacion = temaCapacitacionService.findOne(key);
        model.addAttribute("temaCapacitacionCrear", dataTemaCapacitacion);
    ...
    public String crear(@RequestParam(value = "temaCapacitacion", required = true) Integer temaCapacitacionId,
        ...
        try {
            ...
            model.addAttribute(NOMBRE_DEFECTO_FTL, pregunta1);
            model.addAttribute("temaCapacitacionCrear", temaCapacitacion);
        }
        return CREATE_TEMPLATE;
    }
