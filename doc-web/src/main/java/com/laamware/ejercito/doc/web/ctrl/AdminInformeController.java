    ...
    public String init(
        ...
        try {
            ...
            if (usuario.trim().length() > 0) {
                ...
                /*
                 * Issue #123 (SICDI-Controltech) hotfix-123: Corrección en 
                 * búsqueda de usuarios para que únicamente presente 
                 * información de usuarios activos.
                 */
                usuarioModelo = usuarioRepository.getByLoginAndActivoTrue(usuario.trim());
