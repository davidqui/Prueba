-- ------------------------------------------------------------ 
-- 2018-02-14 edison.gonzalez@controltechcg.com Issue #149 (SICDI-Controltech)
-- feature-149: Ajuste del cargo principal de los usuarios.
-- ------------------------------------------------------------
...
BEGIN
   ...
   SELECT USU_GRADO,USU_NOMBRE,(SELECT CAR_NOMBRE FROM CARGO WHERE CAR_ID = USU_CARGO_PRINCIPAL_ID),USU_TELEFONO INTO V_USU_GRADO_ELABORA,V_USU_NOMBRE_ELABORA,V_USU_CARGO_ELABORA,V_USU_TEL_ELABORA FROM USUARIO WHERE USU_ID = V_USU_ID_ELABORA;
   ...
   IF V_USU_ID_FIRMA IS NOT NULL THEN
      ...
      SELECT USU_GRADO, USU_IMAGEN_FIRMA_EXT,USU_NOMBRE,(SELECT CAR_NOMBRE FROM CARGO WHERE CAR_ID = USU_CARGO_PRINCIPAL_ID),DEP_ID,USU_TELEFONO,USU_EMAIL INTO V_USU_GRADO_FIRMA, V_IMAGEN_FIRMA_EXT,V_USU_NOMBRE_FIRMA,V_USU_CARGO_FIRMA,V_DEP_ID,V_USU_TELEFONO,V_USU_EMAIL FROM USUARIO WHERE USU_ID = V_USU_ID_FIRMA;
      --GRADO LARGO
