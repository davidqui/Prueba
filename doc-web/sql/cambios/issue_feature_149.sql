...
drop sequence USUARIO_CARGO_HISTORICO_SEQ;
...
create table CARGO_HISTORICO(
    ...
    "CAR_ID"                NUMBER(*,0)     NOT NULL,
    CAR_NOMBRE_ANTERIOR     VARCHAR2(200)   NULL,
    CAR_NOMBRE_NUEVO        VARCHAR2(200)   NULL,
...
COMMENT ON COLUMN DOC.CARGO_HISTORICO.CAR_NOMBRE_NUEVO IS 'Descripción del cargo como se encontraba despues de su modificación';
...
create table USUARIO_CARGO_HISTORICO(
    ...
    CARGO_PRINCIPAL_NUEVO           NUMBER(*,0),
    CARGO1_ID_ANTERIOR              NUMBER(*,0),
    CARGO1_ID_NUEVO                 NUMBER(*,0),
    CARGO2_ID_ANTERIOR              NUMBER(*,0),
    CARGO2_ID_NUEVO                 NUMBER(*,0),
    CARGO3_ID_ANTERIOR              NUMBER(*,0),
    CARGO3_ID_NUEVO                 NUMBER(*,0),
    CARGO4_ID_ANTERIOR              NUMBER(*,0),
    CARGO4_ID_NUEVO                 NUMBER(*,0),
    CARGO5_ID_ANTERIOR              NUMBER(*,0),
    CARGO5_ID_NUEVO                 NUMBER(*,0),
    CARGO6_ID_ANTERIOR              NUMBER(*,0),
    CARGO6_ID_NUEVO                 NUMBER(*,0),
    CARGO7_ID_ANTERIOR              NUMBER(*,0),
    CARGO7_ID_NUEVO                 NUMBER(*,0),
    CARGO8_ID_ANTERIOR              NUMBER(*,0),
    CARGO8_ID_NUEVO                 NUMBER(*,0),
    CARGO9_ID_ANTERIOR              NUMBER(*,0),
    CARGO9_ID_NUEVO                 NUMBER(*,0),
    CARGO10_ID_ANTERIOR             NUMBER(*,0),
    CARGO10_ID_NUEVO                NUMBER(*,0),
    CAR_HIS_FEC_MOD                 TIMESTAMP       NOT NULL,
    ...
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK14" FOREIGN KEY ("CARGO1_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK15" FOREIGN KEY ("CARGO2_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK16" FOREIGN KEY ("CARGO3_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK17" FOREIGN KEY ("CARGO4_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK18" FOREIGN KEY ("CARGO5_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK19" FOREIGN KEY ("CARGO6_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK20" FOREIGN KEY ("CARGO7_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK21" FOREIGN KEY ("CARGO8_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK22" FOREIGN KEY ("CARGO9_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK23" FOREIGN KEY ("CARGO10_ID_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID"),
    CONSTRAINT "USUARIO_CARGO_HISTORICO_FK24" FOREIGN KEY ("CARGO_PRINCIPAL_NUEVO") REFERENCES "DOC"."CARGO" ("CAR_ID")
);

COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.USU_CAR_HIS_ID IS 'Identificador único de la tabla';
...
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO_PRINCIPAL_NUEVO IS 'Descripción del cargo principal antes de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO1_ID_NUEVO IS 'Identificador del cargo alterno #1 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO2_ID_NUEVO IS 'Identificador del cargo alterno #2 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO3_ID_NUEVO IS 'Identificador del cargo alterno #3 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO4_ID_NUEVO IS 'Identificador del cargo alterno #4 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO5_ID_NUEVO IS 'Identificador del cargo alterno #5 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO6_ID_NUEVO IS 'Identificador del cargo alterno #6 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO7_ID_NUEVO IS 'Identificador del cargo alterno #7 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO8_ID_NUEVO IS 'Identificador del cargo alterno #8 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO9_ID_NUEVO IS 'Identificador del cargo alterno #9 despues de su modificación';
COMMENT ON COLUMN DOC.USUARIO_CARGO_HISTORICO.CARGO10_ID_NUEVO IS 'Identificador del cargo alterno #10 despues de su modificación';
...
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX13 ON USUARIO_CARGO_HISTORICO(CARGO_PRINCIPAL_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX14 ON USUARIO_CARGO_HISTORICO(CARGO1_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX15 ON USUARIO_CARGO_HISTORICO(CARGO2_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX16 ON USUARIO_CARGO_HISTORICO(CARGO3_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX17 ON USUARIO_CARGO_HISTORICO(CARGO4_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX18 ON USUARIO_CARGO_HISTORICO(CARGO5_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX19 ON USUARIO_CARGO_HISTORICO(CARGO6_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX20 ON USUARIO_CARGO_HISTORICO(CARGO7_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX21 ON USUARIO_CARGO_HISTORICO(CARGO8_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX22 ON USUARIO_CARGO_HISTORICO(CARGO9_ID_NUEVO);
CREATE INDEX USUARIO_CARGO_HISTORICO_IDX23 ON USUARIO_CARGO_HISTORICO(CARGO10_ID_NUEVO);

insert into ROL (ROL_ID, QUIEN, CUANDO, QUIEN_MOD, CUANDO_MOD, ACTIVO, ROL_NOMBRE) values ('ADMIN_CARGOS',3390, sysdate,3390,sysdate,1,'Administrar cargos');
COMMIT;