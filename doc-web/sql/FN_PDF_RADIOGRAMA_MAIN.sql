-- ------------------------------------------------------------ 
-- -- 2018-09-19 samuel.delgado@controltechcg.com Issue gogs #15 (SICDI-Controltech)
-- -- feature-gogs-15: Ajuste correspondiente a la linea de mando.
-- -- ------------------------------------------------------------
...
RETURN VARCHAR2 is
  ...
  */
  ...
  -- hotfix-171: Variables de apoyo para consultas de ajuste de cargo_id_firma.
  V_TMP_DOC_USU_ELAB_CUANDO_MAX DOCUMENTO_USU_ELABORA.CUANDO%TYPE;
  V_TMP_DOC_USU_ELAB_CAR_ID_ELA DOCUMENTO_USU_ELABORA.CARGO_ID_ELABORA%TYPE;
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('Inicio proceso main');
   ...
   --
   -- 2018-05-22 jgarcia@controltechcg.com Issue #171 (SICDI-Controltech)
   -- hotfix-171: Modificación en función para buscar el cargo_id_elabora
   -- del documento, cuando este por algún motivo es NULL.
   --
   IF v_documento.CARGO_ID_ELABORA IS NULL THEN
        DBMS_OUTPUT.PUT_LINE('v_documento.CARGO_ID_ELABORA IS NULL! : '|| v_documento.DOC_ID);
        SELECT MAX(CUANDO) INTO V_TMP_DOC_USU_ELAB_CUANDO_MAX FROM DOCUMENTO_USU_ELABORA WHERE DOC_ID = V_DOCUMENTO.DOC_ID AND USU_ID_ELABORA = V_DOCUMENTO.USU_ID_ELABORA AND CARGO_ID_ELABORA IS NOT NULL;
        DBMS_OUTPUT.PUT_LINE('Establece V_TMP_DOC_USU_ELAB_CUANDO_MAX: ' || v_documento.DOC_ID || ' ' || v_documento.USU_ID_ELABORA || ' ' || V_TMP_DOC_USU_ELAB_CUANDO_MAX);
        
        IF V_TMP_DOC_USU_ELAB_CUANDO_MAX IS NOT NULL THEN
            SELECT CARGO_ID_ELABORA INTO V_TMP_DOC_USU_ELAB_CAR_ID_ELA FROM DOCUMENTO_USU_ELABORA WHERE DOC_ID = V_DOCUMENTO.DOC_ID AND USU_ID_ELABORA = V_DOCUMENTO.USU_ID_ELABORA AND CARGO_ID_ELABORA IS NOT NULL AND CUANDO = V_TMP_DOC_USU_ELAB_CUANDO_MAX;
            DBMS_OUTPUT.PUT_LINE('Establece V_TMP_DOC_USU_ELAB_CAR_ID_ELA: ' || v_documento.DOC_ID || ' ' || v_documento.USU_ID_ELABORA || ' ' || V_TMP_DOC_USU_ELAB_CAR_ID_ELA);
            
            IF V_TMP_DOC_USU_ELAB_CAR_ID_ELA IS NOT NULL THEN
                UPDATE DOCUMENTO SET CARGO_ID_ELABORA = V_TMP_DOC_USU_ELAB_CAR_ID_ELA WHERE DOC_ID = V_DOCUMENTO.DOC_ID;
                COMMIT;
                DBMS_OUTPUT.PUT_LINE('Actualiza DOCUMENTO.CARGO_ID_ELABORA: ' || v_documento.DOC_ID || ' ' || v_documento.USU_ID_ELABORA);

                SELECT * INTO v_documento FROM DOCUMENTO WHERE DOC_ID = P_DOC_ID;
                DBMS_OUTPUT.PUT_LINE('Actualiza informacion v_documento: ' || v_documento.DOC_ID || ' ' || v_documento.USU_ID_ELABORA || ' ' || v_documento.CARGO_ID_ELABORA);                                
            END IF;
        END IF;
   END IF;
   ...
   DBMS_OUTPUT.PUT_LINE('Consulta OK INFORMACION_FIRMA : '|| P_USU_ID_FIRMA);
   
   SELECT CAR_NOMBRE INTO V_USU_CARGO_FIRMA FROM CARGO WHERE CAR_ID = v_documento.CARGO_ID_FIRMA;
   DBMS_OUTPUT.PUT_LINE('Consulta OK V_USU_CARGO_FIRMA : '|| V_USU_CARGO_FIRMA);
   --GFRADO LARGO
   ...
   DBMS_OUTPUT.PUT_LINE('Consulta OK TRD.TRD_CODIGO : '|| V_TRD_CODIGO);
    ...
    V_SIGLA_LARGA_DE := V_DEPENCIA_NOMBRE;
    V_PADRE_ORIGEN := FN_LINEA_MANDO_DEPENDENCIA(v_documento.DEP_ID_DES);
...
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.1';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
--     ELSIF V_SIGLA_CORTA_DE = 'CI3MO2' THEN
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.2';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
--     ELSIF V_SIGLA_CORTA_DE = 'CI3MO3' THEN
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.3';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
--     ELSIF V_SIGLA_CORTA_DE = 'CI3MO4' THEN
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.4';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
--     ELSIF V_SIGLA_CORTA_DE = 'CI3MO5' THEN
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.5';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
--     ELSIF V_SIGLA_CORTA_DE = 'CI3MO6' THEN
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.6';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
--     ELSIF V_SIGLA_CORTA_DE = 'CI3MO7' THEN
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.7';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
--     ELSIF V_SIGLA_CORTA_DE = 'CI3MO8' THEN
--       V_SIGLA_LARGA_DE := 'CENTRO INTEGRADO INFORMACION INTELIGENCIA MILITAR OPERACIONAL No.8';
--       V_PADRE_ORIGEN := 'JEMOP-CAIMI-CI3ME-';
...
--       V_PADRE_ORIGEN := 'JEMOP';
--        ELSIF V_SIGLA_CORTA_DE = 'B16' THEN
--       V_SIGLA_LARGA_DE := 'DÉCIMO SEXTA BRIGADA';
--       V_PADRE_ORIGEN := 'JEMOP-DIV08-B16';
--        ELSIF V_SIGLA_CORTA_DE = 'BR28' THEN
--       V_SIGLA_LARGA_DE := 'VIGÉSIMA OCTAVA BRIGADA';
--       V_PADRE_ORIGEN := 'JEMOP-DIV08-B28';
--     ELSIF V_SIGLA_CORTA_DE = 'BACIF1' THEN
--       V_SIGLA_LARGA_DE := 'BATALLÓN DE CONTRAINTELIGENCIA DE FRONTERAS No 1';
--       V_PADRE_ORIGEN := 'JEMOP-CACIM-BRCIM1-';
--     ELSIF V_SIGLA_CORTA_DE = 'BACIF2' THEN
--       V_SIGLA_LARGA_DE := 'BATALLÓN DE CONTRAINTELIGENCIA DE FRONTERAS No 2';
--       V_PADRE_ORIGEN := 'JEMOP-CACIM-BRCIM1-';
--     ELSIF V_SIGLA_CORTA_DE = 'BACIF3' THEN
--       V_SIGLA_LARGA_DE := 'BATALLÓN DE CONTRAINTELIGENCIA DE FRONTERAS No 3';
--       V_PADRE_ORIGEN := 'JEMOP-CACIM-BRCIM1-';
--     ELSIF V_SIGLA_CORTA_DE = 'BACIF4' THEN
--       V_SIGLA_LARGA_DE := 'BATALLÓN DE CONTRAINTELIGENCIA DE FRONTERAS No 4';
--       V_PADRE_ORIGEN := 'JEMOP-CACIM-BRCIM1-';
--     ELSIF V_SIGLA_CORTA_DE = 'BACIF5' THEN
--       V_SIGLA_LARGA_DE := 'BATALLÓN DE CONTRAINTELIGENCIA DE FRONTERAS No 5';
--       V_PADRE_ORIGEN := 'JEMOP-CACIM-BRCIM1-';
--     ELSE
--       V_SIGLA_LARGA_DE := '';
--       V_PADRE_ORIGEN := '';
