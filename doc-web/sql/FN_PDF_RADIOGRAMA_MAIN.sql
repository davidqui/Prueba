...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('Inicio proceso main');
   ...
   SELECT USU_GRADO, USU_IMAGEN_FIRMA_EXT,USU_NOMBRE,(SELECT CAR_NOMBRE FROM CARGO WHERE CAR_ID = USU_CARGO_PRINCIPAL_ID), DEP_ID,USU_TELEFONO,USU_EMAIL INTO V_USU_GRADO_FIRMA, V_IMAGEN_FIRMA_EXT,V_USU_NOMBRE_FIRMA,V_USU_CARGO_FIRMA,V_DEP_ID,V_USU_TELEFONO,V_USU_EMAIL FROM USUARIO WHERE USU_ID = P_USU_ID_FIRMA;
   --GFRADO LARGO
...
--   DBMS_OUTPUT.PUT_LINE('Consulta OK DOCUMENTO.USU_ID_FIRMA : '|| P_USU_ID_FIRMA);
--
--   SELECT USU_GRADO, USU_IMAGEN_FIRMA_EXT,USU_NOMBRE,USU_CARGO, DEP_ID,USU_TELEFONO,USU_EMAIL INTO V_USU_GRADO_FIRMA, V_IMAGEN_FIRMA_EXT,V_USU_NOMBRE_FIRMA,V_USU_CARGO_FIRMA,V_DEP_ID,V_USU_TELEFONO,V_USU_EMAIL FROM USUARIO WHERE USU_ID = P_USU_ID_FIRMA;
--   --GFRADO LARGO
--   SELECT GRA_NOMBRE INTO V_USU_GRADO_FIRMA FROM GRADO g INNER JOIN USUARIO u ON g.GRA_ID = u.USU_GRADO WHERE u.USU_ID = P_USU_ID_FIRMA;
--   IF V_IMAGEN_FIRMA_EXT IS NULL THEN
--      RAISE EXCEPTION_NO_IMG_FIRMA;
