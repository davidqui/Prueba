...
is
    ...
    P_ARRAY_UUID_DOC_ADJUNTO_TMP    DOCUMENTO_ADJUNTO.DAD_ID%TYPE;
...
BEGIN
    ...
    FOR AUX_C_DOC_ADJUNTO IN C_DOC_ADJUNTO LOOP
        ...
        P_ARRAY_UUID_DOC_ADJUNTO_TMP := P_ARRAY_UUID_DOC_ADJUNTO(V_CANTIDAD);
        DBMS_OUTPUT.PUT_LINE('P_ARRAY_UUID_DOC_ADJUNTO_TMP: ' || P_ARRAY_UUID_DOC_ADJUNTO_TMP);
        IF P_ARRAY_UUID_DOC_ADJUNTO_TMP IS NULL THEN
            SELECT LOWER(SYS_GUID()) INTO P_ARRAY_UUID_DOC_ADJUNTO_TMP FROM DUAL;
        END IF;
        INSERT INTO DOCUMENTO_ADJUNTO (DAD_ID, TDO_ID, CUANDO, QUIEN, DOC_ID, DAD_CONTENT, DAD_ORIGINAL, DAD_DESCRIPCION, ACTIVO)
        VALUES (P_ARRAY_UUID_DOC_ADJUNTO_TMP,AUX_C_DOC_ADJUNTO.TDO_ID, AUX_C_DOC_ADJUNTO.CUANDO, AUX_C_DOC_ADJUNTO.QUIEN, P_DOC_ID_NUEVO, AUX_C_DOC_ADJUNTO.DAD_CONTENT, AUX_C_DOC_ADJUNTO.DAD_ORIGINAL, AUX_C_DOC_ADJUNTO.DAD_DESCRIPCION, AUX_C_DOC_ADJUNTO.ACTIVO);
        V_CANTIDAD := V_CANTIDAD + 1;
    END LOOP;
