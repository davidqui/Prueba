...
COMMENT ON COLUMN EXPEDIENTE_ESTADO.USU_SEL_ID IS 'Identificador unico de la tabla';
COMMENT ON COLUMN EXPEDIENTE_ESTADO.USU_ID IS 'Identificador del usuario de origen';
COMMENT ON COLUMN EXPEDIENTE_ESTADO.USU_FAV IS 'Identificador del usuario favorito';
COMMENT ON COLUMN EXPEDIENTE_ESTADO.CONTADOR IS 'Identifica el numero de veces que selecciona el usuario favorito';
