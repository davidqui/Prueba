...
BEGIN
    ...
    THEN
        ...
        INSERT INTO DESTINO_EXTERNO VALUES(local_sequence, UPPER(AUX_C_DOCUMENTOS.MARCA_AGUA_EXTERNO), UPPER(AUX_C_DOCUMENTOS.MARCA_AGUA_EXTERNO), 3390, 1, SYSDATE, 3390, SYSDATE);
