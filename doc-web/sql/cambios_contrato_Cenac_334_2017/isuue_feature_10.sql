    ...
    FOR AUX_C_DOCUMENTOS IN C_DOCUMENTOS LOOP
        BEGIN
          ...
          when no_data_found then
            ...
            INSERT INTO DOC.DESTINO_EXTERNO VALUES(local_sequence, TRIM(UPPER(AUX_C_DOCUMENTOS.MARCA_AGUA_EXTERNO)), TRIM(UPPER(AUX_C_DOCUMENTOS.MARCA_AGUA_EXTERNO)), 3390, 0, SYSDATE, 3390, SYSDATE, null);
